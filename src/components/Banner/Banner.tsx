...
function Banner() {
    return (
        <div className="xl:h-[230px] xl:px-[100px] px-4 py-10 w-full flex items-center  bg-violet-600 text-white text-start">
            <div className="w-[70%]">
            ...
            <div className="w-[30%] md:block hidden pl-5 xl:pl-[10%]">
                ...
                <Image src="/divulgacion-y-acceso.png" alt="IMG " height={150} width={150} />
